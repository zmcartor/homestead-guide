...
https://build.expanse.org/builds/Windows%20Go%20master%20branch/. The
latest version is always available as
`Geth-Win64-latest.zip <https://build.expanse.org/builds/Windows%20Go%20master%20branch/Geth-Win64-latest.zip>`__
...
9.  Open a terminal and download go-expanse
    ``go get -d -u github.com/expanse-org/go-expanse``
10. Try building expanse with go dep, navigate to
    ``c:\godev\src\github.com\expanse\go-expanse\cmd\geth`` and run
